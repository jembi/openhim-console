...
export OPENHIM_API_HOST=${OPENHIM_API_HOST:-"localhost"}
...
export OPENHIM_API_PORT=${OPENHIM_API_PORT:-"5001"}
...
export OPENHIM_CONSOLE_ENVIRONMENT=${OPENHIM_CONSOLE_ENVIRONMENT:-"production"}


cat default-env.json | envsubst | tee /usr/share/nginx/html/config/default.json

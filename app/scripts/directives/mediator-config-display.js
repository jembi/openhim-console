...
angular.module('openhimConsoleApp')
  .directive('mediatorConfigDisplay', function(){
    return{
      restrict: 'EA',
      scope: {
        configDefs: '=',
  ...
  .directive('mediatorNestedConfigDisplay', function($compile){
    return{
      restrict: 'EA',
      scope: {
        configDefs: '=',
      ...
      link: function(scope, element){
        if (scope.config) {
          element.append('<div mediator-config-display config-defs="configDefs" config="config"/>');

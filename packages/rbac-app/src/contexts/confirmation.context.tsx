...
interface ConfirmationContextProps {
  showConfirmation: (message: string, title: string, onYes: () => unknown, onNo?: () => unknown, size?: 'xs' | 'sm' | 'md' | 'lg' | 'xl') => void;
...
export const ConfirmationProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const showConfirmation = (message: string, title: string, onYes: () => unknown, onNo: () => unknown = () => {}, size: 'xs' | 'sm' | 'md' | 'lg' | 'xl' = 'sm') => {

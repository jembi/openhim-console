...
export function handleOnChange(
  ...
  setUser: React.Dispatch<React.SetStateAction<Readonly<User>>>,
  validateUserField: (field: string, newBasicInfoState?: object) => void
) {
...
export function handleFieldValidationAndUpdateErrors(

...
describe('Controller: VisualizerModalCtrl', function () {
  ...
  defaultVisualizerSettings = {
    ...
    size: {responsive: true, width: 1000, height: 400, padding: 20},
    time: {
      updatePeriod: 200,
  ...
  validSettings = {
    ...
    mediators: [
      {
        mediator: 'urn:uuid:a15c3d48-0686-4c9b-b375-f68d2f244a33',
        name: 'file-queue',
        display: 'file-queue',
        $$hashKey: '01S'
      }
  ...
  var selectedMediator = {
    _id: '572aeeea22997473431c9486',
    urn: 'urn:uuid:20cbc520-128e-11e6-922a-27f0e7107fa1',
    version: '0.1.0',
    name: 'Tutorial Mediator Java',
    description: 'This is the Java mediator being used in this tutorial',
    __v: 0,
    configDefs: [],
        ...
        routes: [
          {
            ...
            port: 4002,
            host: 'localhost',
            name: 'Tutorial Mediator Java Route',
            _id: '57a09d1e1b437e8c17b95e42',
            forwardAuthHeader: false,
            status: 'enabled',
            type: 'http'
          }
  ...
  beforeEach(inject(function ($controller, $rootScope, $httpBackend) {
    ...
    $httpBackend
      .when('GET', new RegExp('config/visualizer.json'))
      .respond(defaultVisualizerSettings)
  ...
  it('should execute addSelectedChannel() and add channel to settings object', function () {
    ...
    defaultVisualizerSettings.channels.push({
      eventType: 'channel',
      eventName: selectedChannel.name,
      display: selectedChannel.name
    })
  ...
  it('should execute addSelectedMediator() and add mediator to settings object', function () {
    ...
    defaultVisualizerSettings.mediators.push({
      mediator: selectedMediator.urn,
      name: selectedMediator.name,
      display: selectedMediator.name
    })
  ...
  it('should execute addComponent() and add component to settings object', function () {
    ...
    defaultVisualizerSettings.components.push({

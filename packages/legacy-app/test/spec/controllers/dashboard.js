...
describe('Controller: DashboardCtrl', function () {
  ...
  beforeEach(inject(function ($controller, $rootScope, $httpBackend) {
    ...
    timeLoadDataHours = [
      {total: 21, avgResp: 43269.95, timestamp: hoursAgo(4).format()},
    ...
    timeLoadDataDays = [
      {total: 21, avgResp: 43269.95, timestamp: daysAgo(4).format()},
    ...
    var channelsData = [
      {
        _id: {channelID: '53884f881fdb6f2d69e29cff'},
        failed: 10,
        successful: 58,
        processing: 0,
        completed: 20,
      ...
      {
        _id: {channelID: '12344f881faa6f2d69e29cee'},
        failed: 8,
        successful: 43,
        processing: 2,
        completed: 4,
      ...
      {
        _id: {channelID: '53884f881fdb6f2d35353cdd'},
        failed: 16,
        successful: 26,
        processing: 0,
        completed: 8,
    ...
    $httpBackend
      .when('GET', new RegExp('.*/metrics/timeseries/hour'))
      .respond(timeLoadDataHours)
    $httpBackend
      .when('GET', new RegExp('.*/metrics/channels.*'))
      .respond(channelsData)
    $httpBackend
      .when('GET', new RegExp('.*/channels'))
      .respond([
        {
  ...
  it('should run updateMetrics() and create transactionLoadData scope object (default: hours)', function () {
    ...
    scope.transactionLoadData.data[0].should.have.property(
      'timestamp',
      hoursAgo(4).format('YYYY-MM-DD HH:mm')
    )
    scope.transactionLoadData.data[0].should.have.property('value', 21)
    scope.transactionLoadData.data[1].should.have.property(
      'timestamp',
      hoursAgo(3).format('YYYY-MM-DD HH:mm')
    )
    scope.transactionLoadData.data[1].should.have.property('value', 65)
    scope.transactionLoadData.data[2].should.have.property(
      'timestamp',
      hoursAgo(2).format('YYYY-MM-DD HH:mm')
    )
    scope.transactionLoadData.data[2].should.have.property('value', 32)
    scope.transactionLoadData.data[3].should.have.property(
      'timestamp',
      hoursAgo(1).format('YYYY-MM-DD HH:mm')
    )
    scope.transactionLoadData.data[3].should.have.property('value', 13)
    scope.transactionLoadData.data[4].should.have.property(
      'timestamp',
      hoursAgo(0).format('YYYY-MM-DD HH:mm')
    )
  ...
  it('should run updateMetrics() and create transactionResponseTimeData scope object (default: hours)', function () {
    ...
    scope.transactionResponseTimeData.labels[0].should.equal(
      'Response Time (ms)'
    )

    scope.transactionResponseTimeData.data.length.should.equal(5)

    scope.transactionResponseTimeData.data[0].should.have.property(
      'timestamp',
      hoursAgo(4).format('YYYY-MM-DD HH:mm')
    )
    scope.transactionResponseTimeData.data[0].should.have.property(
    ...
    scope.transactionResponseTimeData.data[1].should.have.property(
      'timestamp',
      hoursAgo(3).format('YYYY-MM-DD HH:mm')
    )
    scope.transactionResponseTimeData.data[1].should.have.property(
    ...
    scope.transactionResponseTimeData.data[2].should.have.property(
      'timestamp',
      hoursAgo(2).format('YYYY-MM-DD HH:mm')
    )
    scope.transactionResponseTimeData.data[2].should.have.property(
    ...
    scope.transactionResponseTimeData.data[3].should.have.property(
      'timestamp',
      hoursAgo(1).format('YYYY-MM-DD HH:mm')
    )
    scope.transactionResponseTimeData.data[3].should.have.property(
    ...
    scope.transactionResponseTimeData.data[4].should.have.property(
      'timestamp',
      hoursAgo(0).format('YYYY-MM-DD HH:mm')
    )
    scope.transactionResponseTimeData.data[4].should.have.property(
  ...
  it('should run updateMetrics() and create transactionLoadData scope object (days)', function () {
    httpBackend
      .expectGET(new RegExp('.*/metrics/timeseries/day'))
      .respond(timeLoadDataDays)
    createController()
    ...
    scope.transactionLoadData.data[0].should.have.property(
      'timestamp',
      daysAgo(4).format('YYYY-MM-DD HH:mm')
    )
    scope.transactionLoadData.data[0].should.have.property('value', 21)
    scope.transactionLoadData.data[1].should.have.property(
      'timestamp',
      daysAgo(3).format('YYYY-MM-DD HH:mm')
    )
    scope.transactionLoadData.data[1].should.have.property('value', 65)
    scope.transactionLoadData.data[2].should.have.property(
      'timestamp',
      daysAgo(2).format('YYYY-MM-DD HH:mm')
    )
    scope.transactionLoadData.data[2].should.have.property('value', 32)
    scope.transactionLoadData.data[3].should.have.property(
      'timestamp',
      daysAgo(1).format('YYYY-MM-DD HH:mm')
    )
    scope.transactionLoadData.data[3].should.have.property('value', 13)
    scope.transactionLoadData.data[4].should.have.property(
      'timestamp',
      daysAgo(0).format('YYYY-MM-DD HH:mm')
    )
    scope.transactionLoadData.data[4].should.have.property('value', 56)
  })

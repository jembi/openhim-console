...
describe('Controller: AuditDetailsCtrl', function () {
  ...
  beforeEach(inject(function (
    ...
    $httpBackend
      .when('GET', new RegExp('.*/audits/538ed0867962a27d5df259b0'))
      .respond({
    ...
    createController = function () {
      ...
      scope = $rootScope.$new()
      return $controller('AuditDetailsCtrl', {
        $scope: scope,
        $routeParams: {auditId: '538ed0867962a27d5df259b0'}
      })
    }
  }))
  ...
  it('should attach a single audit to the scope', function () {
    createController()
    httpBackend.flush()
    scope.auditDetails.eventIdentification.eventDateTime.should.equal(
      '2015-02-17T15:38:25.282+02:00'
    )
    ...
    scope.auditDetails.auditSourceIdentification.auditSourceID.should.equal(
      'openhim'
    )

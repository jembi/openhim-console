...
var req = https.request(options, function (res) {
  ...
  res.on('end', () => {
    ...
    replaceStringInline(
      /"minimumCoreVersion":"[0-9]{1,2}\.[0-9]{1,2}\.[0-9]{1,2}"/,
      `"minimumCoreVersion": "${minimumCoreVersion}"`,
      ['./app/config/default.json']
    )
    // Edit readme with compatible version of core
    replaceStringInline(
      /badge\/openhim--core-[0-9]{1,2}\.[0-9]{1,2}/,
      `badge/openhim--core-${minimumCoreVersion.substr(0, 3)}`,
      ['README.md']
    )
    replaceStringInline(
      /openhim.readthedocs.org\/en\/v[0-9]{1,2}\.[0-9]{1,2}\.[0-9]{1,2}/,
...
replaceStringInline(
  /"version":"[0-9]{1,2}\.[0-9]{1,2}\.[0-9]{1,2}"/,
